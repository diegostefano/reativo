// ======================================================================
// teste_controlador.v generated from TopDesign.cysch
// 05/03/2020 at 15:06
...
// QuadDec_v3_0(Counter8bit=false, CounterResolution=1, CounterSize=32, CounterSizeReplacementString=int32, CounterSizeReplacementStringUnsigned=uint16, TypeCastReplacementString=int32, UsingGlitchFiltering=true, UsingIndexInput=false, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=QuadDec_v3_0, CY_CONFIG_TITLE=QuadDec2, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=QuadDec2, CY_INSTANCE_SHORT_NAME=QuadDec2, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=QuadDec2, )
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=true, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=1000, CompareValue2=63, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=2000, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=BlocoPWM1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=BlocoPWM1, CY_INSTANCE_SHORT_NAME=BlocoPWM1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=BlocoPWM1, )
module PWM_v3_30_4 (
    reset,
    clock,
    tc,
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=1, CompareMode=0, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=32768, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=32768, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=32768, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=16, RunMode=0, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONFIG_TITLE=Cnt16, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=QuadDec1:Cnt16, CY_INSTANCE_SHORT_NAME=Cnt16, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=QuadDec1_Cnt16, )
...
// QuadDec_v3_0(Counter8bit=false, CounterResolution=1, CounterSize=32, CounterSizeReplacementString=int32, CounterSizeReplacementStringUnsigned=uint16, TypeCastReplacementString=int32, UsingGlitchFiltering=true, UsingIndexInput=false, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=QuadDec_v3_0, CY_CONFIG_TITLE=QuadDec1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=QuadDec1, CY_INSTANCE_SHORT_NAME=QuadDec1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=QuadDec1, )
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=true, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=1000, CompareValue2=63, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=2000, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=BlocoPWM3, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=BlocoPWM3, CY_INSTANCE_SHORT_NAME=BlocoPWM3, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=BlocoPWM3, )
module PWM_v3_30_7 (
    reset,
    clock,
    tc,
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=1, CompareMode=0, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=32768, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=32768, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=32768, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=16, RunMode=0, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONFIG_TITLE=Cnt16, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=QuadDec3:Cnt16, CY_INSTANCE_SHORT_NAME=Cnt16, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=QuadDec3_Cnt16, )
...
// QuadDec_v3_0(Counter8bit=false, CounterResolution=1, CounterSize=32, CounterSizeReplacementString=int32, CounterSizeReplacementStringUnsigned=uint16, TypeCastReplacementString=int32, UsingGlitchFiltering=true, UsingIndexInput=false, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=QuadDec_v3_0, CY_CONFIG_TITLE=QuadDec3, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=QuadDec3, CY_INSTANCE_SHORT_NAME=QuadDec3, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=QuadDec3, )
...
// Timer_v2_80(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=true, CaptureMode=1, CONTROL3=0, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, DeviceFamily=PSoC5, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, HWCaptureCounterEnabled=false, InterruptOnCapture=false, InterruptOnFIFOFull=false, InterruptOnTC=true, IntOnCapture=0, IntOnFIFOFull=0, IntOnTC=1, NumberOfCaptures=1, param45=1, Period=69, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, Resolution=8, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=0, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=false, TriggerMode=0, UDB16=false, UDB24=false, UDB32=false, UDB8=true, UDBControlReg=true, UsesHWEnable=0, VerilogSectionReplacementString=sT8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Timer_v2_80, CY_CONFIG_TITLE=TimerCinematico, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=TimerCinematico, CY_INSTANCE_SHORT_NAME=TimerCinematico, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=80, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=TimerCinematico, )
...
module top ;
    ...
    PWM_v3_30_0 BlocoPWM2 (
        ...
        .ph1(Net_2023),
        .ph2(Net_2024));
    defparam BlocoPWM2.Resolution = 16;

    QuadDec_v3_0_2 QuadDec2 (
        .quad_A(Net_14),
        .quad_B(Net_15),
        .index(1'b0),
        .clock(Net_32),
        .interrupt(Net_17));
    defparam QuadDec2.CounterResolution = 1;
    defparam QuadDec2.UsingGlitchFiltering = 1;
    defparam QuadDec2.UsingIndexInput = 0;

	wire [0:0] tmpOE__qa2_net;
	wire [0:0] tmpIO_0__qa2_net;
	wire [0:0] tmpINTERRUPT_0__qa2_net;
	electrical [0:0] tmpSIOVREF__qa2_net;
	...
	cy_psoc3_pins_v1_10
		...
		qa2
		 (.oe(tmpOE__qa2_net),
		  .y({1'b0}),
		  .fb({Net_14}),
		  .io({tmpIO_0__qa2_net[0:0]}),
		  .siovref(tmpSIOVREF__qa2_net),
		  .interrupt({tmpINTERRUPT_0__qa2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__qa2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__qb2_net;
	wire [0:0] tmpIO_0__qb2_net;
	wire [0:0] tmpINTERRUPT_0__qb2_net;
	electrical [0:0] tmpSIOVREF__qb2_net;

	cy_psoc3_pins_v1_10
		#(.id("d11937ea-8b74-46a8-8990-a27d3bbc20c8"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		qb2
		 (.oe(tmpOE__qb2_net),
		  .y({1'b0}),
		  .fb({Net_15}),
		  .io({tmpIO_0__qb2_net[0:0]}),
		  .siovref(tmpSIOVREF__qb2_net),
		  .interrupt({tmpINTERRUPT_0__qb2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__qb2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__dir2_net;
	wire [0:0] tmpFB_0__dir2_net;
	wire [0:0] tmpIO_0__dir2_net;
	wire [0:0] tmpINTERRUPT_0__dir2_net;
	electrical [0:0] tmpSIOVREF__dir2_net;

	cy_psoc3_pins_v1_10
		#(.id("fa7211aa-7ae5-47c3-8243-f42289c088da"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		dir2
		 (.oe(tmpOE__dir2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__dir2_net[0:0]}),
		  .io({tmpIO_0__dir2_net[0:0]}),
		  .siovref(tmpSIOVREF__dir2_net),
		  .interrupt({tmpINTERRUPT_0__dir2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__dir2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    assign Net_33 = 1'h1;

	wire [0:0] tmpOE__slp2_net;
	wire [0:0] tmpFB_0__slp2_net;
	wire [0:0] tmpIO_0__slp2_net;
	wire [0:0] tmpINTERRUPT_0__slp2_net;
	electrical [0:0] tmpSIOVREF__slp2_net;

	cy_psoc3_pins_v1_10
		#(.id("4ea63577-efe8-4d56-acdb-387060897ea8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		slp2
		 (.oe(tmpOE__slp2_net),
		  .y({Net_33}),
		  .fb({tmpFB_0__slp2_net[0:0]}),
		  .io({tmpIO_0__slp2_net[0:0]}),
		  .siovref(tmpSIOVREF__slp2_net),
		  .interrupt({tmpINTERRUPT_0__slp2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__slp2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    PWM_v3_30_4 BlocoPWM1 (
        .reset(Net_34),
        .clock(Net_32),
        .tc(Net_2026),
        .pwm1(Net_2027),
        ...
        .ph1(Net_2035),
        .ph2(Net_2036));
    defparam BlocoPWM1.Resolution = 16;

    QuadDec_v3_0_6 QuadDec1 (
        .quad_A(Net_47),
        .quad_B(Net_48),
        .index(1'b0),
        .clock(Net_32),
        .interrupt(Net_50));
    defparam QuadDec1.CounterResolution = 1;
    defparam QuadDec1.UsingGlitchFiltering = 1;
    defparam QuadDec1.UsingIndexInput = 0;

	wire [0:0] tmpOE__qa1_net;
	wire [0:0] tmpIO_0__qa1_net;
	wire [0:0] tmpINTERRUPT_0__qa1_net;
	electrical [0:0] tmpSIOVREF__qa1_net;

	cy_psoc3_pins_v1_10
		#(.id("6755c7d9-791c-4b23-82ae-cbfdb08a8320"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		qa1
		 (.oe(tmpOE__qa1_net),
		  .y({1'b0}),
		  .fb({Net_47}),
		  .io({tmpIO_0__qa1_net[0:0]}),
		  .siovref(tmpSIOVREF__qa1_net),
		  .interrupt({tmpINTERRUPT_0__qa1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__qa1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__qb1_net;
	wire [0:0] tmpIO_0__qb1_net;
	wire [0:0] tmpINTERRUPT_0__qb1_net;
	electrical [0:0] tmpSIOVREF__qb1_net;

	cy_psoc3_pins_v1_10
		#(.id("cb519356-1d30-4016-acbe-282ce4110250"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		qb1
		 (.oe(tmpOE__qb1_net),
		  .y({1'b0}),
		  .fb({Net_48}),
		  .io({tmpIO_0__qb1_net[0:0]}),
		  .siovref(tmpSIOVREF__qb1_net),
		  .interrupt({tmpINTERRUPT_0__qb1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__qb1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("fa30b6b8-b071-451d-89a7-42d54681a4b2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__slp1_net;
	wire [0:0] tmpFB_0__slp1_net;
	wire [0:0] tmpIO_0__slp1_net;
	wire [0:0] tmpINTERRUPT_0__slp1_net;
	electrical [0:0] tmpSIOVREF__slp1_net;

	cy_psoc3_pins_v1_10
		#(.id("0f776411-29d9-40a8-92cb-777be2a2b2ba"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		slp1
		 (.oe(tmpOE__slp1_net),
		  .y({Net_51}),
		  .fb({tmpFB_0__slp1_net[0:0]}),
		  .io({tmpIO_0__slp1_net[0:0]}),
		  .siovref(tmpSIOVREF__slp1_net),
		  .interrupt({tmpINTERRUPT_0__slp1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__slp1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    PWM_v3_30_7 BlocoPWM3 (
        .reset(Net_52),
        .clock(Net_32),
        .tc(Net_2037),
        .pwm1(Net_2038),
        ...
        .ph1(Net_2046),
        .ph2(Net_2047));
    defparam BlocoPWM3.Resolution = 16;

    QuadDec_v3_0_9 QuadDec3 (
        .quad_A(Net_65),
        .quad_B(Net_66),
        .index(1'b0),
        .clock(Net_32),
        .interrupt(Net_68));
    defparam QuadDec3.CounterResolution = 1;
    defparam QuadDec3.UsingGlitchFiltering = 1;
    defparam QuadDec3.UsingIndexInput = 0;

	wire [0:0] tmpOE__qa3_net;
	wire [0:0] tmpIO_0__qa3_net;
	wire [0:0] tmpINTERRUPT_0__qa3_net;
	electrical [0:0] tmpSIOVREF__qa3_net;

	cy_psoc3_pins_v1_10
		#(.id("308a5630-3daf-4adb-8607-ffa4d5ecdbb0"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		qa3
		 (.oe(tmpOE__qa3_net),
		  .y({1'b0}),
		  .fb({Net_65}),
		  .io({tmpIO_0__qa3_net[0:0]}),
		  .siovref(tmpSIOVREF__qa3_net),
		  .interrupt({tmpINTERRUPT_0__qa3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__qa3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__qb3_net;
	wire [0:0] tmpIO_0__qb3_net;
	wire [0:0] tmpINTERRUPT_0__qb3_net;
	electrical [0:0] tmpSIOVREF__qb3_net;

	cy_psoc3_pins_v1_10
		#(.id("c69e0876-cf2f-4fb7-989b-255026d328ca"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		qb3
		 (.oe(tmpOE__qb3_net),
		  .y({1'b0}),
		  .fb({Net_66}),
		  .io({tmpIO_0__qb3_net[0:0]}),
		  .siovref(tmpSIOVREF__qb3_net),
		  .interrupt({tmpINTERRUPT_0__qb3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__qb3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("629a1cd1-9d42-4a9e-bb47-a02fb3aeb080"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__dir3_net;
	wire [0:0] tmpFB_0__dir3_net;
	wire [0:0] tmpIO_0__dir3_net;
	wire [0:0] tmpINTERRUPT_0__dir3_net;
	electrical [0:0] tmpSIOVREF__dir3_net;

	cy_psoc3_pins_v1_10
		#(.id("d540859b-e65f-451a-a07c-a8a94fb6cca6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		dir3
		 (.oe(tmpOE__dir3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__dir3_net[0:0]}),
		  .io({tmpIO_0__dir3_net[0:0]}),
		  .siovref(tmpSIOVREF__dir3_net),
		  .interrupt({tmpINTERRUPT_0__dir3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__dir3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    assign Net_69 = 1'h1;

	wire [0:0] tmpOE__slp3_net;
	wire [0:0] tmpFB_0__slp3_net;
	wire [0:0] tmpIO_0__slp3_net;
	wire [0:0] tmpINTERRUPT_0__slp3_net;
	electrical [0:0] tmpSIOVREF__slp3_net;

	cy_psoc3_pins_v1_10
		#(.id("ed341be5-9c51-46aa-ae54-4faeb0e93199"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		slp3
		 (.oe(tmpOE__slp3_net),
		  .y({Net_69}),
		  .fb({tmpFB_0__slp3_net[0:0]}),
		  .io({tmpIO_0__slp3_net[0:0]}),
		  .siovref(tmpSIOVREF__slp3_net),
		  .interrupt({tmpINTERRUPT_0__slp3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__slp3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    ZeroTerminal ZeroTerminal_1 (
        .z(Net_70));

    Timer_v2_80_10 TimerMotores (
        .reset(Net_70),
        .interrupt(Net_71),
        .enable(1'b1),
        .trigger(1'b1),
        ...
        .tc(Net_76),
        .clock(Net_667));
    defparam TimerMotores.CaptureCount = 2;
    defparam TimerMotores.CaptureCounterEnabled = 0;
    defparam TimerMotores.DeviceFamily = "PSoC5";
    defparam TimerMotores.InterruptOnCapture = 0;
    defparam TimerMotores.InterruptOnTC = 1;
    defparam TimerMotores.Resolution = 8;
    defparam TimerMotores.SiliconRevision = "0";
	...
	cy_psoc3_pins_v1_10
		#(.id("c94bf289-f2a5-4047-87ae-11b1857b70a6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    Timer_v2_80_11 TimerCinematico (
        .reset(Net_658),
        .interrupt(Net_78),
        .enable(1'b1),
        .trigger(1'b1),
        ...
        .tc(Net_83),
        .clock(Net_667));
    defparam TimerCinematico.CaptureCount = 2;
    defparam TimerCinematico.CaptureCounterEnabled = 0;
    defparam TimerCinematico.DeviceFamily = "PSoC5";
    defparam TimerCinematico.InterruptOnCapture = 0;
    defparam TimerCinematico.InterruptOnTC = 1;
    defparam TimerCinematico.Resolution = 8;
    defparam TimerCinematico.SiliconRevision = "0";
	...
	wire [0:0] tmpOE__dir1_net;
	wire [0:0] tmpFB_0__dir1_net;
	wire [0:0] tmpIO_0__dir1_net;
	wire [0:0] tmpINTERRUPT_0__dir1_net;
	electrical [0:0] tmpSIOVREF__dir1_net;

	cy_psoc3_pins_v1_10
		#(.id("5ee0b83f-f0e0-4a87-b07e-7e3f93bda659"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		dir1
		 (.oe(tmpOE__dir1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__dir1_net[0:0]}),
		  .io({tmpIO_0__dir1_net[0:0]}),
		  .siovref(tmpSIOVREF__dir1_net),
		  .interrupt({tmpINTERRUPT_0__dir1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__dir1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("cb5aea0b-dc20-4c42-a3dd-15c2e07a70b6"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8413af41-b0f1-41ae-9dfe-c2b86919b3b4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
